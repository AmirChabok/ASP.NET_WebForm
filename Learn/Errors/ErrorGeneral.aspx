<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ErrorGeneral.aspx.cs" Inherits="Errors_ErrorGenerals" %>
        ...
        <form id="form1" runat="server">
			...
			================================================== -->
                ...
                <div id="content">
                    ...
                    <h1>
                        &nbsp
                         <asp:Label ID="lblError" runat="server" Text="<%$Resources:Captions,UnexpectedError%>" />
                        <br />
                        <br />
                        &nbsp
                        <asp:HyperLink ID="lnkTryAgain" runat="server" Text="<%$Resources:Captions,TryAgainTitle %>" />
