<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Error403.aspx.cs" Inherits="Errors_Error403" %>
			...
			================================================== -->
                ...
                <div id="content">
                    ...
                    <h1>
                        &nbsp
                        &nbsp
                        <asp:Label ID="lblError" runat="server" Text="<%$Resources:Captions,Forbidden%>" />
