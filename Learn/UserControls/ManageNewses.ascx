<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ManageNewses.ascx.cs" Inherits="UserControls_ManageNewses" %>
...
<div class="container">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DataAccessLayer.Properties.Settings.Cwx121ConnectionString %>" SelectCommand="SELECT * FROM [Posts] WHERE ([IsCommentEnabled] = @IsCommentEnabled)">
        <SelectParameters>
            <asp:Parameter DefaultValue="true" Name="IsCommentEnabled" Type="Boolean" />
        </SelectParameters>
    </asp:SqlDataSource>
