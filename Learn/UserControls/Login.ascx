...
<div class="container">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-heading">
            <asp:Literal ID="litLegend" runat="server" Text="<%$Resources:Captions,Login%>" />
        </div>
    ...
    <div class="panel">
        <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-success" Text="<%$Resources:Buttons,Submit %>" OnClick="btnSubmit_Click" />

    </div>

    <div class="container">
        <asp:HyperLink ID="lnkFP" runat="server" NavigateUrl="~/ForgetPassword.aspx" Text="<%$Resources:Captions,ForgetPassword%>"></asp:HyperLink>
    </div>
