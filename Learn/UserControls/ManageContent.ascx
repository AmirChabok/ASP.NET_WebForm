<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ManageContent.ascx.cs" Inherits="UserControls_ManageContent" %>
...
<div class="container">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <asp:Label ID="lblPostID" runat="server" CssClass="col-md-2" Text="<%$Resources:Captions,PostID%>" />

                <div class="col-md-10">
                    <asp:TextBox ID="txtPostID" runat="server" CssClass="form-control" MaxLength="30" />
                </div>
